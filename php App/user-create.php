    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($errors)) {
            ...
            if (empty($errors)) {
                ...
                $query = "INSERT INTO users (user_name, name, email, password, phone, image, address, type_user) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                $stmt = $conn->prepare($query);
                ...
                if ($stmt->execute()) {
                    ...
                    header("Location: users-index.php?success=Create New User is successfully");
                    exit();
                } else {
                    header("Location: user-create.php?error=Create User failed: " . $stmt->errorInfo());
                    exit();
                }
            }
        }
                                        ...
                                        <div class="table_section padding_infor_info">
                                            <div class="table-responsive-sm">
                                                <div class="msg_list_main">
                                                    ...
                                                    <?php } ?>
                                                    <form method="post" action="user-create.php" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-md">
                                                        ...
                                                        <input type="submit" name="submit" class="main_bt mx-5 mt-5 me-5" value="Create New User">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
