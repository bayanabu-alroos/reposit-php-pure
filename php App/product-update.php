...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    if (isset($_GET['product_id'])) {
        ...
        // Query the database to retrieve the product details using $product_id
        ...
        if ($productData) {
            // Now you have the product details in $productData, and you can use it to populate your form.
        } else {
            echo "Product not found"; // Handle the case when the product doesn't exist.
        }
    } else {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($errors)) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: product-update.php?error=Product Updated failed.");
                exit();
            }
        }
    }
                                            ...
                                            <div class="table-responsive-sm">
                                                <div class="msg_list_main">
                                                    <form method="post" action="product-update.php" enctype="multipart/form-data">
                                                        <input type="hidden" name="product_id" id="update_id" value="<?php echo $productData['product_id']; ?>">
                                                        <div class="row">
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control" value="<?php echo $productData['product_title']; ?>" id="product_title" name="product_title" placeholder="Product Title">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="file" value="<?php echo $productData['product_img1']; ?>" class="form-control" id="product_img1" name="product_img1" id="product_img1" accept="image/*">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="file" class="form-control" value="<?php echo $productData['product_img2']; ?>" name="product_img2" id="product_img2" accept="image/*">
                                                        ...
                                                        <div class="row mb-4">
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="file" class="form-control" id="product_img3" value="<?php echo $productData['product_img3']; ?>" name="product_img3" accept="image/*">
                                                                    <label for="product_img3">Product Image Three</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="file" class="form-control" accept="image/*" value="<?php echo $productData['product_img1']; ?>" id="product_img4" name="product_img4" accept="image/*">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="text" value="<?php echo $productData['product_price']; ?>" class="form-control" id="product_price" name="product_price" placeholder="Product Price">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="text" value="<?php echo $productData['past_price']; ?>" class="form-control" id="past_price" name="past_price" placeholder=" Past Price  Product">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control" id="product_keywords" value="<?php echo $productData['product_keywords']; ?>" name="product_keywords" placeholder="Product Keywords">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="form-floating">
                                                                    <textarea type="text" class="form-control" id="product_desc" name="product_desc" placeholder="Product Description"><?php echo $productData['product_desc']; ?></textarea>
                                                                    <label for="product_desc">Product Description</label>
                                                                </div>
                                                                <span class="text-danger"><?php echo $errors['product_desc'] ?? ''; ?></span>
                                                            </div>
                                                        </div>
                                                        <input type="submit" name="submit" class="main_bt mx-5 mt-5 me-5" value="Update Product">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
